...
public class BorderDemo {
	 public static void main(String[] args) 
	 {
		 ...
		 panel.setLayout(new GridLayout(0,2,5,10));   //后两个参数为间距

		 panel.setBorder(BorderFactory.createEmptyBorder(50,50,50,5));  //设置边距
		 ...
		 JScrollPane scrollPane = new JScrollPane(panel);      //自动出现滚动条
